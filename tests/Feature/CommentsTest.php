...
//                        'details' => 'The data.attributes.message field is required.',
                        'details' => 'Поле data.attributes.message обязательно для заполнения.',
                        'source' => [
...
//                        'details' => 'The data.attributes.message must be a string.',
                        'details' => 'Значение поля data.attributes.message должно быть строкой.',
                        'source' => [
                            'pointer' => '/data/attributes/message',
                        ]
                    ]
...
//                        'details' => 'The data.attributes.message must be a string.',
    ...
    {
        $comments = Comment::factory(3)->create()->each(function ($item, $index) {
