...
//                        'details' => 'The data.attributes.title field is required.',
                        'details' => 'Поле data.attributes.title обязательно для заполнения.',
                        'source' => [
...
//                        'details' => 'The data.attributes.description field is required.',
                        'details' => 'Поле data.attributes.description обязательно для заполнения.',
                        'source' => [
...
//                        'details' => 'The data.attributes.publication year field is required.',
                        'details' => 'Поле data.attributes.publication year обязательно для заполнения.',
                        'source' => [
