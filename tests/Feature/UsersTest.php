...
//                        'details' => 'The data.attributes.email field is required.',
                        'details' => 'Поле data.attributes.email обязательно для заполнения.',
                        'source' => [
...
//                        'details' => 'The data.attributes.email must be a valid email address.',
                        'details' => 'Значение поля data.attributes.email должно быть действительным электронным адресом.',
                        'source' => [
                            'pointer' => '/data/attributes/email',
                        ]
                    ]
...
//                        'details' => 'The data.attributes.password field is required.',
                        'details' => 'Поле data.attributes.password обязательно для заполнения.',
                        'source' => [
...
//                        'details' => 'The data.attributes.password must be a string.',
                        'details' => 'Значение поля data.attributes.password должно быть строкой.',
                        'source' => [
                            'pointer' => '/data/attributes/password',
                        ]
                    ]
